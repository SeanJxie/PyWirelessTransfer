...
def main() -> None:
    mode = input(
        "Would you like this machine to be "
        "the file sender or receiver? (s/r): "
    ).lower()
    ...
    if mode == "r":
        ...
        ftserver = server.Server(
            input(
                "Enter the path of the directory you "
                "would like to transfer your files TO: "
            )
        )
        ...
        ftclient = client.Client(
            ...
            input(
                "Enter the path of the directory you "
                "would like to transfer your files FROM: "
            ),
        )
